  ...
  return (
    <div className="min-h-screen bg-transparent flex flex-col font-sans">
      ...
      <header className="border-b border-white/20 bg-white/40 backdrop-blur-md px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
        ...
        <Link to={`/register${location.search}`} className="text-base sm:text-lg font-medium text-neutral-700 hover:text-emerald-600 transition-colors">
          Sign up
        </Link>
      </header>
        ...
        <div className="w-full max-w-[560px] bg-white/80 backdrop-blur-xl rounded-[2rem] sm:rounded-[2.5rem] shadow-[0_8px_40px_rgba(0,0,0,0.04)] p-6 sm:p-10 md:p-12 border border-white">
          ...
          <div className="mt-10 pt-8 border-t border-neutral-100 text-center">
            <p className="text-neutral-600 text-sm">
              ...
              <Link to={`/register${location.search}`} className="text-emerald-600 font-medium hover:text-teal-600 hover:underline transition-colors">
                Sign up
              </Link>
            </p>
          </div>
